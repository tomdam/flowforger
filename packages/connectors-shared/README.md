# @flowforger/connectors-shared

**Shared utilities and base types** for FlowForger connector packages (`@flowforger/connectors-*`) — common request handling, parameter normalization, and metadata helpers.

You normally don't install this directly; it comes in as a dependency of the individual connectors.

## Installation

```bash
npm install @flowforger/connectors-shared
```
